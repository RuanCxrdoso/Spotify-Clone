      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6 mb-14 overflow-auto">
          ...
          <div className='grid grid-cols-3 gap-5 mt-8'>
            <a href='' className='flex items-center justify-between bg-white/20 rounded overflow-hidden'>
              <div className='flex items-center'>
                <div className='overflow-hidden'>
                  <Image src="/astroworld.jpg" width={100} height={100} alt="ASTROWORLD Album Cover" className='hover:scale-125 transition-all duration-500' />
                </div>
                <h1 className='ml-4 font-semibold'>ASTROWORLD</h1>
              </div>
              <button className='bg-green-600 rounded-full p-3 opacity-0 hover:opacity-90 transition-opacity duration-300 '>
                <Play />
              </button> {/*rever como ajeitar esse botao no final da box (tentar com position)*/}
            </a>
            <a href='' className='flex items-center bg-white/20 rounded overflow-hidden'>
              <div className='overflow-hidden'>
                <Image src="/issa.png" width={100} height={100} alt='ISSA Album Cover' className='hover:scale-125 transition-all duration-500' />
              </div>
              <h1 className='ml-4 font-semibold'>ISSA Album</h1>
              <button className='ml-24 bg-green-600 rounded-full p-3 opacity-0 hover:opacity-90 transition-opacity duration-300 '>
                <Play />
              </button>
            </a>
            <a href='' className='flex items-center bg-white/20 rounded overflow-hidden'>
              <div className="overflow-hidden">
                <Image src="/maquinadotempo.webp" width={100} height={100} alt='Máquina do Tempo Album Cover' className='hover:scale-125 transition-all duration-500' />
              </div>
              <h1 className='ml-4 font-semibold'>Máquina do Tempo</h1>
              <button className='ml-10 bg-green-600 rounded-full p-3 opacity-0 hover:opacity-90 transition-opacity duration-300 '>
                <Play />
              </button>
            </a >
            <a href='' className='flex items-center bg-white/20 rounded overflow-hidden'>
              <div className="overflow-hidden">
                <Image src="/savagemode.jpg" width={100} height={100} alt='Savage Mode II Album Cover' className='hover:scale-125 transition-all duration-500' />
              </div>
              <h1 className='ml-4 font-semibold'>SAVAGE MODE II</h1>
              <button className='ml-16 bg-green-600 rounded-full p-3 opacity-0 hover:opacity-90 transition-opacity duration-300 '>
                <Play />
              </button>
            </a>
            <a href='' className='flex items-center bg-white/20 rounded overflow-hidden'>
              <div className="overflow-hidden">
                <Image src="/We_Love_You_Tecca.jpeg" height={100} width={100} alt='We Love You Tecca Album Cover' className='hover:scale-125 transition-all duration-500' />
              </div>
              <h1 className='ml-4 font-semibold'>We Love You Tecca</h1>
              <button className='ml-12 bg-green-600 rounded-full p-3 opacity-0 hover:opacity-90 transition-opacity duration-300 '>
                <Play />
              </button>
            </a>
            <a href='' className='flex items-center bg-white/20 rounded overflow-hidden'>
              <div className="overflow-hidden">
                <Image src="/utopia.png" width={100} height={100} alt='UTOPIA Album Cover' className='hover:scale-125 transition-all duration-500' />
              </div>
              <h1 className='ml-4 font-semibold'>UTOPIA</h1>
              <button className='ml-32 bg-green-600 rounded-full p-3 opacity-0 hover:opacity-90 transition-opacity duration-300 '>
                <Play />
              </button>
            </a>
          </div>
          ...
          <div className='h-96 grid grid-cols-5 gap-16 px-2 overflow-y-scroll'>

            <a className='bg-zinc-800 p-3 rounded'>
              <Image src="/GiftCourse.png" width={290} height={290} alt='Gift and Course Album Cover' className='rounded'/>
              <h1 className='mt-5 mb-1 font-semibold'>Gift & a Curse</h1>
            ...
            <a className='bg-zinc-800 p-3 rounded'>
              ...
              <h1 className='mt-5 mb-1 font-semibold'>XO Tour Llife3</h1>
