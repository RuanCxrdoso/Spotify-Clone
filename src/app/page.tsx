      ...
      <div className="flex flex-1">
        ...
        <aside className="w-72 bg-zinc-950 p-6">
          ...
          <nav className='flex flex-col gap-3 mt-6 pt-6 border-t border-zinc-800 overflow-auto'>
            ...
            <a href="" className='text-sm text-zinc-400 hover:text-zinc-100 transition-colors duration-500'>Máquina do Tempo</a>
        ...
        <main className="flex-1 p-6 mb-14 overflow-auto">
          ...
          {/* Solucinar a centralização do play nos albúns inferiores para telas maiores*/}
          <div className='h-96 grid grid-cols-5 gap-16 px-2 mb-8 overflow-y-scroll'>

            <a className='bg-zinc-800 p-3 rounded group hover:bg-zinc-700 transition-colors duration-300 cursor-pointer'>
              <div className='relative overflow-hidden'>
                ...
                <div className='bg-green-600 rounded-full p-3 opacity-100 group-hover:opacity-100 translate-y-52 group-hover:translate-y-0 transition-all duration-500 absolute top-1/3 left-1/3'>
                  <Play />
                </div>
              </div>
